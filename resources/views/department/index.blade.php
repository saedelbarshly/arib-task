        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex items-center justify-between mt-4">
                    ...
                    <a href="{{ route('department.create') }}" class=" font-bold py-2 text-white px-4 rounded"
                ...
                $(document).on('click', '.delete-department', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = `{{ route('department.delete', ':department') }}`
                                .replace(':department', departmentId);
                        }
                    });
                });
            });
