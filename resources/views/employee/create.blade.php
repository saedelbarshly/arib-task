                ...
                <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="image"
                            ...
                            type="file" name="image" id="formFile" required autofocus autocomplete="image" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone"
                            :value="old('phone')" required autofocus autocomplete="phone" placeholder="01123456789" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                            :value="old('email')" required autocomplete="username" placeholder="test@gmail.com" />
